...
The hostname for SSH connections to Gadi is gadi.nci.org.au. Your username is provided when you created your NCI account. You can check it via [Mancini/MyNCI](https://my.nci.org.au/).
